...
class LungSegmentationApp:
    ...
    def save_segmentation_result(self, patient_id):
        ...
        cursor.execute(
            "INSERT INTO SegmentationResult (ResultID, ImageID, SegmentationTime, ResultPath, DiceCoefficient, IoU) VALUES (%s, %s, %s, %s, %s, %s)",
            (patient_id, patient_id, timestamp, result_path, dice, iou_value)
        )
